    ...
    <div class="px-6 py-8 max-w-4xl mx-auto">
        ...
        <div v-if="!hasResults">
            ...
            >
                ...
                <div
                    v-if="files.length === 0"
                    class="h-32 flex flex-col items-center justify-center text-gray-400"
                >
                    <svg
                        class="w-8 h-8 mb-2"
                        xmlns="http://www.w3.org/2000/svg"
        ...
        <div v-if="hasResults" class="mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-6 mb-6">
                ...
                <p class="text-gray-800">
                    ...
                    <strong>{{ (overallConfidence * 100).toFixed(1) }}%</strong
                    >.
                </p>
            </div>
...
const overallPrediction = computed(() => {
    ...
    return msCount >= results.value.length / 2 ? "MSP" : "No MS";
});
