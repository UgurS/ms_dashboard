<template>
    <div>
        ...
        <p class="text-gray-600 mb-6">
            Manage all patient records, search through the list, and add new
            patients easily.
        </p>
        ...
        <div v-if="patientStore.loading" class="text-center text-gray-500">
            Loading...
        </div>
        <div v-else-if="patientStore.error" class="text-red-600 text-sm">
            {{ patientStore.error }}
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="patient in filteredPatients" :key="patient.id">
                        ...
                        >
                            ...
                            <router-link
                                :to="{
                                    path: `/patients/${patient.id}/diagnosis`,
                                }"
                            ...
                            <router-link
                                :to="{ path: `/patient/${patient.id}/history` }"
